...
실시간 라인 검출과 에러 계산을 통해 자율주행, 로봇 라인 추적 등 다양한 응용 가능

8. 개선점 및 향후 과제

밝기 보정과 임계값 이진화 대신 적응형 이진화(Adaptive Thresholding) 적용 가능

후보 영역 필터링 조건 개선으로 더 안정적인 라인 선택 가능

다중 라인 추적 및 PID 제어와 연계하여 실제 로봇 제어 실험 수행 가능
